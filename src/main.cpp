/* =======================================================================================
 * Прошивка простого балансирующего робота, автор Цыганок Максим 
 * Youtube канал Max Gear: https://www.youtube.com/channel/UC7bvRu-UWm-fxdevJ6c9jQw
 * Поддержите подпиской :) 
 * 
 * Видео про то как работает и как сделать простого балансирующего робота:
 * 
 * Пишите вопросы в комментариях под видео
 * =======================================================================================
 */
...
// принцип работы подсмотрен в grbl прошивке для чпу станков, использует всего 1 аппаратный таймер и 32 битные целые числа,
// можно легко масштабировать для управления несколькими драйверами независимо
// это прерывание должно работать максимально быстро, в данном виде использует около 20% процессорного времени микроконтроллера
...
//  ПИД регуляторы
//=======================================================================================//
// Самописная библиотека реализующая ПИД регулятор, файлы PID.cpp и PID.h, не комментировал.
#include "PID.h"
